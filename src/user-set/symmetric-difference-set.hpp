...
class SymmetricDifferenceSet : public DerivativeSet {
    public:
        SymmetricDifferenceSet(UserSet* parent, const pstring& name, UserSet* set1, UserSet* set2) noexcept;
        SymmetricDifferenceSet(UserSet* parent, const pstring& name) noexcept;
